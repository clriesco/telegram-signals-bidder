...
@Component({
  selector: 'app-ended-signals',
  templateUrl: './ended-signals.component.html',
  styleUrls: ['./ended-signals.component.css']
})
export class EndedSignalsComponent implements OnInit, AfterViewInit {

  dataSource: SignalDataSource;
  displayedColumns = ['creation_date', 'currency', 'commodity', 'price', 'close_price', 'percent', 'time', 'status', 'chart', 'actions'];
  len: Number;
  type = 'ended';
